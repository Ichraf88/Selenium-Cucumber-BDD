...
public class WishlistSteps {
	...
	@Then("le message suivant doit apparaitre Emty {string}")
	public void leMessageSuivantDoitApparaitreEmty(String emty) {
		validations.assertEquals(WishlistPage.getWishlistVideResult(), emty);
	}
